...
## Project Structure
    ...
    ├── new_app_deploy_dev_128749  # Django project configurations
...
1. Clone this repo and `cd new_app_deploy_dev_128749`
...
2. Clone this repo and `cd new_app_deploy_dev_128749`
